...
const {Country, League, Fixtures, Livescore, Match, Odds, defaultFixtures,  defaultFixtures_Cricket, defaultFixtures_Tennis, Cricket_league, Tennis_league, Live_Football } = require('../controller/Soccer')
